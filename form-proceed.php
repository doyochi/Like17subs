<?php
	include 'koneksi.php';
	$id_app = $_GET['id_app'];
	$query = "SELECT * FROM applicant WHERE id_app=$id_app";
...
?>
  ...
  <main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Proceed Applicant</h2>
          <ol>
            <li><a href="dashboard.php">Home</a></li>
            <li>Proceed Applicant</li>
          </ol>
        </div>
    ...
    <section class="inner-page">
      <div class="container">
        <p>
          ...
          <center><h1>Proceed Applicant</h1></center>
	...
	<!-- <label>Tanggal</label>
        ...
        <center>
		<input type="submit" class="btn btn-warning" name="proses" value="Simpan">
		<input type="reset" class="btn btn-outline-secondary" value="Reset"> <center>
		</form>
		</div>
        </div>
    </section>
